...
class Quote {
   ...
   public:
    ...
    Quote(const Quote& ori) : isbn(ori.isbn), price(ori.price) {
...
class Disc_quote : public Quote {
   ...
   public:
    ...
    Disc_quote(const Disc_quote& ori) : Quote(ori), count(ori.count), discount(ori.discount) {
    ...
    void print_debug() override {
        Quote::print_debug();
        cout << ("count: ") << count << ", discount: " << discount << endl;
    }
};
...
class Bulk_quote : public Disc_quote {
   public:
    ...
    // Bulk_quote(const Bulk_quote& ori) : Disc_quote(ori) {
